...
<div class="flex min-h-[calc(100vh-4rem)] items-center justify-center px-4">
    <div class="w-full max-w-md">
      <div class="text-center">
        <h1 class="text-3xl font-bold tracking-tight"><?php echo e($title); ?></h1>
        <p class="text-muted-foreground mt-1"><?php echo e($description); ?></p>
      </div>

      <?php echo e($slot); ?>

    </div>
</div><?php /**PATH C:\laragon\www\idea\resources\views/components/form/form.blade.php ENDPATH**/ ?>